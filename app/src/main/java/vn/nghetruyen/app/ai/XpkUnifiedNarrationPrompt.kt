...
object XpkUnifiedNarrationPrompt {
    ...
    private fun freesoundRequirementBlock(kinds: Set<AudioAssetKind>): String {
        ...
        return """
            ...
            12. Mỗi requirement BẮT BUỘC thêm local_hint bằng tiếng Việt, tối đa 300 ký tự, đúng dạng "Sắc thái: ...; Dùng: ...; Tránh: ..." để dùng cùng một schema với toàn bộ thư viện. Sắc thái mô tả bản chất âm nghe được (nguồn/vật liệu/cường độ/nhịp/không gian); Dùng nêu 2–5 tình huống phù hợp; Tránh nêu 2–4 near-miss dễ chọn sai. Không kể lại cốt truyện, không tên nhân vật, ID hay tên file. Ví dụ MUSIC: "Sắc thái: dây trầm căng, nhịp tăng dần; Dùng: đối đầu trước giao chiến, nguy hiểm cận kề; Tránh: chiến thắng, lãng mạn". Ví dụ AMBIENCE: "Sắc thái: hang băng kín, gió lạnh vang nhẹ; Dùng: hang băng, đường hầm băng; Tránh: đồng trống, thành phố". Ví dụ SFX: "Sắc thái: xích sắt bật gãy mạnh; Dùng: xích đứt, mắt xích văng; Tránh: kính vỡ, gỗ gãy".
