...
& $Python.Source @PythonPrefix ".\scripts\check_milestone4_foundation.py"
...
$ExtraTasks = if ($env:MILESTONE4_EXTRA_TASKS) { $env:MILESTONE4_EXTRA_TASKS.ToLowerInvariant() } else { "" }
...
Write-Host "Milestone 4 complete build gates completed."
