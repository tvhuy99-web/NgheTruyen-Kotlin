...
for token in ["duckAttackMillis = 1850", "duckReleaseMillis = 2050", "animateDuck", "looping: Boolean = true", "onCompletion: (() -> Unit)?", "baseVolume * duckMultiplier * sfxDuckMultiplier * slot.fadeMultiplier", "coerceIn(0f, 1f)"]:
